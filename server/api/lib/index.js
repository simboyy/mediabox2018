    ...
    toHtml (output, callback) {
        ...
        this.initTemplates((err, templates) => {
            ...
            iterateObject(tasks, (cTask, i) => {
                ...
                cTask.nrCrt = i + 1;
				  cTask.price = parseFloat(cTask.price);
				  cTask.quantity = parseInt(cTask.quantity);
                

                // Build amount object
                cTask.amount = cTask.price * cTask.quantity;
				cTask.amount = parseFloat(cTask.amount);
                 

                // Sum the amount to the total
                invoiceData.total += cTask.amount;
               

                // Set the amount of this row
                cTask.amount = cTask.amount.toFixed(2);
            ...
            // Set the total
            invoiceData.total  = invoiceData.total.toFixed(2);
